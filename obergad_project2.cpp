...
const char* WINDOWTITLE = { "OpenGL / GLUT Sample -- Adam Oberg" };
...
void CreateHat() {
	...
	for (int i = 0; i < num_segments; i++)
	{
		...
		glVertex3f(x, y, base);//output vertex
	...
	float theta = 2.0f * 3.1415926f * float(1) / float(num_segments);//get the current angle
	float x = r * cosf(theta);//calculate the x component
	float y = r * sinf(theta);//calculate the y component
	glVertex3f(x, y, base);//output vertex
	glVertex3f(x, y, z);//output vertex
	theta = 2.0f * 3.1415926f * float(2) / float(num_segments);//get the current angle
	x = r * cosf(theta);//calculate the x component
	y = r * sinf(theta);//calculate the y component
	glVertex3f(x, y, z);//output vertex
	glVertex3f(x, y, base);//output vertex
